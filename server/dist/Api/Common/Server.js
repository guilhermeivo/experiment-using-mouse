...
const StatusCodes_1 = __importDefault(require("@Api/Common/Enumerations/StatusCodes"));
const TypesRequests_1 = __importDefault(require("@Api/Common/Enumerations/TypesRequests"));
const OptionsCors_1 = require("@Api/Common/Interfaces/OptionsCors");
...
class Server {
    static listen(port, hostname) {
        const httpServer = http.createServer((request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.authenticationHandler(request, response);
            this.routes.map((route) => __awaiter(this, void 0, void 0, function* () {
                ...
                switch (route.typeRequest) {
                    case TypesRequests_1.default.Route:
                        if (urlComponents.path.substring(0, urlComponents.path.lastIndexOf('/')) === route.url &&
                            ...
                            responseBodyResponse = yield route.callback(urlComponents.queries, request, response);
    ...
    static addAuthentication(callback) {
